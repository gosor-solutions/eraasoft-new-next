    ...
    <section className={`${Styles.heroSec} lg:min-h-screen`}>
      <div className="px-5 sm:px-8 max-w-350 mx-auto">
        <div className="grid grid-cols-12 lg:min-h-screen">
          {/* ── Text content ── */}
          <div
            className="col-span-12 lg:col-span-6 order-1 lg:order-2 flex flex-col justify-center text-right pt-20 sm:pt-24 lg:pt-0 pb-12 sm:pb-16 lg:pb-0"
            dir="rtl"
          >
            ...
            <div className={`${Styles.description} mb-6 sm:mb-8 md:mb-10`}>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 max-w-2xl leading-relaxed">
                اكتشف كورسات متخصصة في البرمجة، التصميم، والتسويق، وطور مهاراتك
                مع تجربة تعليمية سهلة واحترافية.
              </p>
            </div>
            ...
            <div className={`${Styles.hero_buttons} flex flex-wrap items-center gap-3 sm:gap-4 mb-6 sm:mb-9`}>
              ...
              <button className="bg-transparent border border-gray-400 hover:border-white hover:bg-white/5 text-white font-medium py-3 sm:py-3.5 px-6 sm:px-8 rounded-full transition-all flex items-center gap-3 text-sm sm:text-base lg:text-lg">
                تصفح الخدمات
              </button>
            </div>
...
function StatItem({ icon, value, label }) {
  return (
    <div className="flex items-center gap-3 sm:gap-4">
      <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-[#161e31] border border-[#2a344a] flex items-center justify-center text-[#cfa856] shadow-lg shrink-0">
        {icon}
      </div>
