  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1100px] relative w-full bg-white rounded-[32px] shadow-sm border border-gray-100 p-4 md:p-6 lg:p-8 flex flex-col lg:flex-row-reverse gap-8 items-stretch">
        ...
        <div
          className={`flex-1 flex flex-col ${mode ? "justify-between" : "justify-center"} py-4 px-2 md:px-6 lg:px-10`}
        >
          {/* Mobile Logo */}
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        <Link
                          href={loginHref}
                          className={`flex-1 text-center py-2.5 px-6 rounded-full text-sm font-semibold transition-all duration-300 ${
                            mode === "login"
