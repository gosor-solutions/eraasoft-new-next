...
export default function MaintenancePage({ settings, message }) {
  ...
  return (
    <main
      ...
      style={{
        background:
          "linear-gradient(135deg, #0C1739 0%, #0d1f4a 50%, #0C1739 100%)",
      }}
      dir="rtl"
    >
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10 text-center max-w-2xl mx-auto w-full">
        ...
        <div
          ...
          style={{
            background: "rgba(34, 67, 164, 0.25)",
            border: "1px solid rgba(34, 67, 164, 0.4)",
            color: "#93b4ff",
          }}
        >
          <span
            className="w-2 h-2 rounded-full bg-[#E6C238]"
        ...
        <div
          className="w-full max-w-sm h-1.5 rounded-full mb-10 overflow-hidden"
      ...
      {/* الفوتر */}
      <footer
        className="w-full px-6 py-8 relative z-10"
