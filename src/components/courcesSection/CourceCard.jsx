    ...
    <div className="col-span-12 md:col-span-6 lg:col-span-4 min-[1400px]:col-span-3 border border-(--primary-color) rounded-xl">
      <div className="course_card p-3 sm:p-4 rounded-xl bg-white">
        ...
        <div className="pt-8 sm:pt-10 pb-3 sm:pb-5 relative">
          ...
          {/* Price */}
          <p className="text-(--primary-color) text-2xl sm:text-3xl lg:text-[32px] font-bold mt-2">
          ...
          <div className="flex gap-2 sm:gap-3 mt-3">
            <Link
              ...
              className="main_button grow cursor-pointer text-sm sm:text-base py-3 sm:py-4"
            >
              اشترك الآن
            </Link>
            <Link
              href={`/courses/${course?.slug}`}
              className="bg-[#2243A41A] h-12 w-12 sm:h-15 sm:w-15 rounded-full flex justify-center items-center cursor-pointer shrink-0"
            >
