...
export const metadata = {
  ...
  description:
    "استعرض مشاريع تخرج طلاب إيراسوفت وتعرّف على إنجازاتهم وأعمالهم البرمجية المتميزة.",
};
  ...
  return (
    <>
      <HeroCarousel
        ...
        description={
          "نفخر بإنجازات طلابنا ومشاريعهم المتميزة التي تعكس مستوى التدريب العالي الذي يحصلون عليه في إيراسوفت."
        }
      />
