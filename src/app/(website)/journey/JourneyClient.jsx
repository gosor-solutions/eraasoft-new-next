    ...
    <div className=" min-h-screen text-white" dir="rtl">
      <HeroCarousel
        ...
        description={
          ...
          "خطوات مدروسة بعناية نرافقك فيها من البداية وحتى إطلاق أولى خطواتك المهنية بنجاح في سوق العمل."
        }
                  ...
                  {section.points && section.points.length > 0 && (
                    <ul className="space-y-3">
                      {section.points?.map((point, index) => (
                        <li
                          key={index}
                          className="flex items-start gap-3.5 text-white font-extrabold text-base md:text-lg leading-relaxed"
                        >
                          <span className="text-yellow-500 font-black text-xl mt-0.5">
                            •
                          </span>
                          <span>{point}</span>
                        </li>
...
const DEFAULT_STAGES = [
  ...
  },
  {
    ...
    image:
      "https://panel.eraasoft.com/storage/learning-journeys/clipboard-check.svg",
    sections: [
      {
  ...
  },
  {
    ...
    image:
      "https://panel.eraasoft.com/storage/learning-journeys/briefcase-business.svg",
    sections: [
      {
